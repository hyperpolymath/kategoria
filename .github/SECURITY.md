...
Replace all {{PLACEHOLDER}} values with your information:
  kategoria     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  kategoria             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/kategoria/security/advisories/new)
...
- This repository (`hyperpolymath/kategoria`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/kategoria/security/advisories)
...
When using kategoria, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/kategoria/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/kategoria/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/kategoria/discussions) |
...
*Thank you for helping keep kategoria and its users safe.* 🛡️
