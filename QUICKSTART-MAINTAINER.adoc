...
// Replace kategoria, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= kategoria — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining kategoria for
...
* Upstream: https://github.com/hyperpolymath/kategoria/issues
