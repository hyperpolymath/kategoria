...
// Replace kategoria, Kategoria — See README.adoc for details., just run, Kategoria started successfully. with actuals
= kategoria — Quick Start for Users
:toc:
:toclevels: 2

== What is kategoria?

Kategoria — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./kategoria-portable
----
...
[source]
----
Kategoria started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/kategoria/wiki
